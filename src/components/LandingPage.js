            ...
            <div className="container-2 w-container">
                <div className="question">
                    ...
                    <a href="#" className="option w-inline-block" onClick={() => this.updateChoice("Button1")} >
                        <img src="https://daks2k3a4ib2z.cloudfront.net/588ced82c498fd3f484a861d/59ecd4719d16950001e296a5_003-mountain.png" width="64" className="option-image" alt="Mountains"/>
                    ...
                    <a href="#" className="option w-inline-block" onClick={() => this.updateChoice("Button2")}>
                        <img src="https://daks2k3a4ib2z.cloudfront.net/588ced82c498fd3f484a861d/59ecd471e8bbc50001a51f17_001-clock.png" width="64" className="option-image" alt="Watch" />
                    ...
                    <a href="#" className="option w-inline-block" onClick={() => this.updateChoice("Button3")}>
                        <img src="https://daks2k3a4ib2z.cloudfront.net/588ced82c498fd3f484a861d/59ecd47136e5a0000168e9a1_002-money.png" width="64" className="option-image" alt="Wallet" />
